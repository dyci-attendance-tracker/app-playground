...
function ProfileView() {
  ...
  return (
      <div className="h-full flex flex-col relative rounded-lg transition-all duration-300">
        ...
        <div className="primary lg:p-4 p-3 flex flex-col gap-4">
            <div className='flex items-center gap-3'>
            <BoxIcon size={24} className="text-gray-500" />
            <div className=" text-left w-full pr-3">
                ...
                <Typography className="text-sm text-color-secondary">
            ...
            <span className="flex flex-col gap-0 items-start w-full">
                <Typography className="text-sm text-color-secondary">Email</Typography>
                <Typography className="text-sm text-color">{profile.email}</Typography>
            </span>
            <span className="flex flex-col gap-0 items-start w-full">
                <Typography className="text-sm text-color-secondary">Phone</Typography>
            ...
            <div className="flex flex-col gap-0 items-start w-full">
                <Typography className="text-sm text-color-secondary">College Department</Typography>
                <Typography className="text-sm text-color">{profile.collegeDepartment || 'N/A'}</Typography>
            </div>
            <div className="flex flex-col gap-0 items-start w-full">
                <Typography className="text-sm text-color-secondary">Course</Typography>
                <Typography className="text-sm text-color">{profile.course || 'N/A'}</Typography>
            </div>
            <div className="flex flex-col gap-0 items-start w-full">
                <Typography className="text-sm text-color-secondary">Year Level</Typography>
                <Typography className="text-sm text-color">{profile.yearLevel || 'N/A'}</Typography>
            </div>
            <div className="flex flex-col gap-0 items-start w-full">
                <Typography className="text-sm text-color-secondary">Section</Typography>
        ...
        <div className="min-w-[300px] min-h-[30vh] px-6 py-2 flex flex-col gap-4 hide-scrollbar mt-4">
          {/* Placeholder or tabs/logs can go here */}
          <Typography className="text-sm text-color-secondary text-left">Events Attended</Typography>
          <Typography className="text-sm text-color-secondary italic">No logs or actions yet.</Typography>
        </div>
      </div>
  );
}
